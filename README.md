...
- [**`useSearchParams`**](https://reactrouter.com/en/main/hooks/use-search-params): URL의 쿼리 파라미터값을 가져오는 리액트 훅입니다. 이를 통해 위의 쿼리값들을 알아냅니다.
...
- [**`useParams`**](https://reactrouter.com/en/main/hooks/use-params): URL의 파라미터 값을 객체로 가져오는 리액트 훅입니다.
